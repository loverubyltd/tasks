...
import com.huawei.cloud.base.http.*
...
internal class HuaweiFlipperHttpInterceptor<T>(private val plugin: NetworkFlipperPlugin, private val responseClass: Class<T>) : HttpExecuteInterceptor,
